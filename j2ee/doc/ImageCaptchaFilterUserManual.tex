...
\begin{figure}[htbp]
	\centering
		\includegraphics[width=1.00\textwidth]{original_petstore.jpg}
...
\begin{figure}[htbp]
	\centering
		\includegraphics[width=1.00\textwidth]{captcha_petstore.jpg}
...
\begin{figure}[htbp]
	\centering
		\includegraphics[width=1.00\textwidth]{signon_src_directory.jpg}
