...
import com.octo.captcha.pix.gimpy.wordtoimages.textpasters.RotatingTextPaster;
...
public class AlternateFactoryInitializer extends FactoryInitializer {
    public static PixCaptchaFactory getPixCaptchaFactory(){
                 AbstractTextPaster paster = new RotatingTextPaster(new Integer(8),new Integer(8));
